 ...
 * BrowserControl
 */
class BrowserControl : public CComPtr<IWebBrowser2>, public CWindowImpl<BrowserControl, CAxWindow>, public IDispEventImpl < 0, BrowserControl >
{
public:
...
private:
  ...
  public:  
    ...
    {
      logger->debug(L"Subclasser::Subclasser -> " + boost::lexical_cast<wstring>(parent));
    }
