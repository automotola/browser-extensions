...
struct button_addCommand : public ForgeCommand
{
  ...
  button_addCommand(const std::wstring& uuid, const std::wstring& title, const std::wstring& icon, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid)
  {
...
struct button_setIconCommand : public ForgeCommand
{
  ...
  button_setIconCommand(const std::wstring& uuid, const std::wstring& url, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid)
  {
...
struct button_setTitleCommand : public ForgeCommand
{
  ...
  button_setTitleCommand(const std::wstring& uuid, const std::wstring& title, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid)
  {
    size_t len = title.copy(this->title, MAX_PATH, 0);
    this->title[len] = L'\0';
  }
...
struct button_setBadgeCommand : public ForgeCommand
{
  ...
  button_setBadgeCommand(const std::wstring& uuid, INT32 number, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid), number(number)
  {
  }
...
struct button_setBadgeBackgroundColorCommand : public ForgeCommand
{
  ...
  button_setBadgeBackgroundColorCommand(const std::wstring& uuid, BYTE r, BYTE g, BYTE b, BYTE a, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid), r(r), g(g), b(b), a(a)
  {
  }
...
struct button_onClickCommand : public ForgeCommand
{
  ...
  button_onClickCommand(const std::wstring& uuid, POINT point, DWORDX processId = NULL, INT_PTRX proxy = NULL) : ForgeCommand(COMMAND_TYPE, processId, proxy, uuid), point(point)
  {
  }
